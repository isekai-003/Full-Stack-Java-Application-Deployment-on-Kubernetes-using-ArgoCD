  ...
  stage("build"){
    ...
    stage(" Docker Build ") {
     ...
     stage("OWASP-ZAP"){
        steps{
            script {
           sh " docker run -v $(pwd):/zap/wrk/:rw -t ghcr.io/zaproxy/zaproxy:stable zap-baseline.py \ -t http://a02d3189494e24646a961fee6254ec7e-1725559781.ap-south-1.elb.amazonaws.com:8080 -r owaspzap.html"
            }
        }
     }
